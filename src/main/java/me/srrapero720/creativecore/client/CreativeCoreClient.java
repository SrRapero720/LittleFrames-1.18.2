package me.srrapero720.creativecore.client;

import com.mojang.brigadier.builder.LiteralArgumentBuilder;
import me.srrapero720.creativecore.client.render.model.FBlockModel;
import me.srrapero720.creativecore.client.render.model.FItemModel;
...
import me.srrapero720.creativecore.common.gui.integration.GuiEventHandler;
...
public class CreativeCoreClient {
    ...
    public static final LocatedHandlerRegistry<FBlockModel> BLOCK_MODEL_TYPES = new LocatedHandlerRegistry<>(null);
    public static final LocatedHandlerRegistry<FItemModel> ITEM_MODEL_TYPES = new LocatedHandlerRegistry<>(null);
    ...
    public static void registerBlockModel(ResourceLocation location, FBlockModel renderer) {
        BLOCK_MODEL_TYPES.register(location, renderer);
    }
    
    public static void registerItemModel(ResourceLocation location, FItemModel renderer) {
