...
public record CreativeUnbakedModel(ResourceLocation item, ResourceLocation block) /*implements IUnbakedGeometry<CreativeUnbakedModel>*/ {
    ...
    public BakedModel bake(GeometricB context, ModelBakery baker, Function<Material, TextureAtlasSprite> spriteGetter, ModelState modelState, ItemOverrides overrides, ResourceLocation modelLocation) {
