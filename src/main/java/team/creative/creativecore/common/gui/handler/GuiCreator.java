    ...
    public static class GuiCreatorItem extends GuiCreator {
        ...
        public GuiCreatorItem() {
            super((nbt, player) -> {
                ...
                if (stack.getItem() instanceof ItemGuiCreator item) return item.create(nbt, player);
                return null;
            });
        }
    ...
    public static class GuiCreatorBlock extends GuiCreator {
        ...
        public GuiCreatorBlock() {
            super((nbt, player) -> {
                ...
                if (state.getBlock() instanceof BlockGuiCreator block) return block.create(nbt, level, pos, state, player);
                return null;
            });
        }
