...
public class LittleFRenderBoxItem extends LittleFRenderBox {
    ...
    public LittleFRenderBoxItem(LittleItemHolder structure, AlignedBox cube, LittleBox box) {
        super(cube);
        this.box = box;
    ...
    public List<BakedQuad> getBakedQuad(LevelAccessor level, BlockPos pos, BlockPos offset, BlockState state, BakedModel blockModel, Facing facing, RenderType layer, Random rand, boolean overrideTint, int defaultColor) {
        ...
        for (int i = 0; i < blockQuads.size(); i++) {
            ...
            FBakedQuad quad = new FBakedQuad(blockQuads.get(i), this, defaultColor, overrideTint, null);
