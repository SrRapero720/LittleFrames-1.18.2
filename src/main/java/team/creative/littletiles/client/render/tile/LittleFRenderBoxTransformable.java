...
public class LittleFRenderBoxTransformable extends LittleFRenderBox {

    private float scale;
    private float inverseScale;
    public VectorFanCache cache;

    public LittleFRenderBoxTransformable(LittleGrid grid, LittleTransformableBox box) {
        super(grid, box);
    ...
    public LittleFRenderBoxTransformable(LittleGrid grid, LittleTransformableBox box, BlockState state) {
    ...
    public LittleFRenderBoxTransformable(LittleGrid grid, LittleTransformableBox box, LittleElement element) {
    ...
    protected float getOverallScale(Facing facing) {
        FRenderBoxFace type = getFace(facing);
